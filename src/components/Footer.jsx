...
const company = ['Vision', 'Mission', 'Core Values', 'Contact Us', 'Branding', 'Team', 'Careers', 'FAQ'];
    ...
    <footer className=" max-w-1600 mx-auto text-center  lg:text-left">
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-2 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="flex flex-col w-full self-stretch lg:self-auto justify-center gap-2">
            {' '}
            <img src={logo} className="w-48 object-cover" alt="logo" />{' '}
            <h3 className="text-blue-800 font-bold text-lg">Subscribe our Newsletter</h3>{' '}
            <div>
              <form>
                <label
      ...
      <div className="p-6 text-center border-t-2 border-gray-200">
        <span>Copyright © 2022. Edaface is a product of EDA Holdings.All Rights Reserve </span>
      </div>
    </footer>
  );
};
